...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"tmux_session_info #363a4f #ed8796 ${TMUX_POWERLINE_SEPARATOR_RIGHT_BOLD}"
#		"hostname 33 0"
		...
		#"wan_ip 24 255"
		"vcs_branch #363a4f #ed8796 ${TMUX_POWERLINE_SEPARATOR_RIGHT_BOLD}"
		"vcs_compare #363a4f #ed8796 ${TMUX_POWERLINE_SEPARATOR_RIGHT_BOLD}"
		"vcs_staged #363a4f #ed8796 ${TMUX_POWERLINE_SEPARATOR_RIGHT_BOLD}"
		"vcs_modified #363a4f #ed8796 ${TMUX_POWERLINE_SEPARATOR_RIGHT_BOLD}"
		#"vcs_others 245 0"
	)
fi
